...
<head>
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet"
               integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous"><!--BOOTSTRAP-->
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.8.1/font/bootstrap-icons.css"><!--IKONE BOOTSTRAP-->
...
<body>
    ...
    <header>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top bg-dark bg-primary">
            <div class="container">
                <a class="navbar-brand" href="home.html" style="color: lightgrey;">
                    <img src="/www/vhost.hr/images/W_Logo.png" width="30" height="30" class="d-inline-block align-top"
                        alt="W_Logo">
                    WareVic
                </a>
                    ...
                    <ul class="nav navbar-nav mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="nav-dropdown">
                                ...
                                <li><a class="dropdown-item" href="all_products.html">All products</a></li>
                            </ul>
                        </li>
